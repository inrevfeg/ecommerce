							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
									   ...
									   <span class="price" id="pprice">${{ $product->selling_price }}</span>
									   @else
									   <span class="price" id="pprice">${{ $product->discount_price }}</span>
											<span class="price-strike" id="oldprice">${{ $product->selling_price }}</span>
									   @endif
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<h5>Choose Color <span class="text-danger">*</span></h5>
			<div class="controls">
		...
		<div class="col-sm-6">
			<div class="form-group">
			<h5>Choose Size <span class="text-danger">*</span></h5>
			<div class="controls">
